        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div className="text-center md:text-left space-y-5 md:space-y-7">
            ...
            <p className="text-base md:text-lg text-foreground/90 leading-relaxed">
              I’m a versatile <span className="font-semibold !text-primary dark:!text-primary">Computer Science Engineer</span> and <span className="font-semibold !text-primary dark:!text-primary">Unity Certified Professional Developer</span> passionate about immersive <span className="font-semibold !text-primary dark:!text-primary">XR experiences</span> and scalable, event-driven <span className="font-semibold !text-primary dark:!text-primary">backends</span>. I take projects from concept to deployment — building interactive <span className="font-semibold !text-primary dark:!text-primary">3D applications</span>, architecting <span className="font-semibold !text-primary dark:!text-primary">multiplayer servers</span>, and managing <span className="font-semibold !text-primary dark:!text-primary">CI/CD pipelines</span> for <span className="font-semibold !text-primary dark:!text-primary">GCP deployment</span>.
            </p>
            <p className="text-base md:text-lg text-foreground/90 leading-relaxed">
              Driven by <span className="font-semibold !text-primary dark:!text-primary">curiosity</span> and a love for <span className="font-semibold !text-primary dark:!text-primary">continuous learning</span>, I stay ahead of <span className="font-semibold !text-primary dark:!text-primary">emerging technologies</span> and embrace <span className="font-semibold !text-primary dark:!text-primary">challenges</span> beyond my core stack. My strength lies in blending <span className="font-semibold !text-primary dark:!text-primary">technical depth</span>, <span className="font-semibold !text-primary dark:!text-primary">creative problem-solving</span>, and a <span className="font-semibold !text-primary dark:!text-primary">DevOps mindset</span> to deliver reliable, high-performance solutions across platforms.
            </p>
          </div>
