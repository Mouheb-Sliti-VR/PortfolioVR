...
export const mockProjects: PortfolioProject[] = [
  {
    id: '1',
    title: 'Partners Marketplace Orange',
    description: 'VR platform connecting brand owners and users in a dynamic VR product showcase',
    ...
    videoUrl: `/videos/marketplace.mp4`,
    dataAiHint: 'VR Products showcase for Orange partners',
    tags: ['VR', 'Unity', 'E-commerce', 'NodeJS'],
    projectUrl: '#',
